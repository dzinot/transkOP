...
import org.transkop.ast._

class TranskopParser extends Parser {


  val ParseError = "Znam sho mu e, rasipan e"

  val DeclareInt = "OVDE AKO MOZHI"
  val SetInitialValue = "I TAKA MU VELAM..."
  val BeginMain = "MAJSTORE TRGAJ"
  val PlusOperator = "EDNA POGORE"
  val MinusOperator = "EDNA PODOLU"
  val MultiplicationOperator = "SHALTOVAJ NAGORE"
  val DivisionOperator = "SHALTOVAJ NADOLU"
  val EndMain = "MAJSTORE STOJ STIGNAVME"
  val Print = "I SHO VIKASH?"
  val Read = "KOLKU PARI?"
  val AssignVariable = "PUCAJ"
  val SetValue = "AJDE AJDE"
  val EndAssignVariable = "4AO MA4E"
  val False = "DAJ BE NE LAZHI"
  val True = "ZHIMI GOSPOT NE LAZHAM"
  val EqualTo = "ORIGINAL OD KINA BRAT"
  val GreaterThan = "NA KOJ MU E POGOLEM?"
  val Or = "ALI"
  val And = "I BAMUJA?"
  val If = "SAMO AKO NE E TAKA"
  val Else = "I POSLE SHO SE DESI?"
  val EndIf = "E AKO NE OVA KOJ KUR?"
  val While = "CHEKAJ BRAT MALKU"
  val EndWhile = "DOSTA E BRAT"
  val DeclareMethod = "POLEKA SITE JAS KAKO SHO KE KAZHAM"
  val MethodArguments = "AJDE TORBITE"
  val Return = "15 MINUTI PAUZA"
  val EndMethodDeclaration = "AJT DOSTA E"
  val CallMethod = "VRTAM 2 BROJA"
  val NonVoidMethod = "SHO SAKAM PRAM"
  val AssignVariableFromMethodCall = "AJDE BRE"
  val Modulo = "GO EBA MENJACHO"
